...
import com.acc.jalo.Greeting;
import com.acc.jalo.TrackLatLong;
...
public abstract class GeneratedServicecoreManager extends Extension
{
	...
	static
	{
		...
		tmp = new HashMap<String, AttributeMode>();
		tmp.put("trackLatLongList", AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractPromotion.condition</code> attribute.
	 * @return the condition
	 */
	public String getCondition(final SessionContext ctx, final AbstractPromotion item)
	{
		return (String)item.getProperty( ctx, ServicecoreConstants.Attributes.AbstractPromotion.CONDITION);
	}
	 ...
	 * @return the condition
	 */
	public String getCondition(final AbstractPromotion item)
	{
		return getCondition( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>AbstractPromotion.condition</code> attribute. 
	 * @param value the condition
	 */
	public void setCondition(final SessionContext ctx, final AbstractPromotion item, final String value)
	{
		item.setProperty(ctx, ServicecoreConstants.Attributes.AbstractPromotion.CONDITION,value);
	}
	 ...
	 * @param value the condition
	 */
	public void setCondition(final AbstractPromotion item, final String value)
	{
		setCondition( getSession().getSessionContext(), item, value );
	}
	...
	public Greeting createGreeting(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( ServicecoreConstants.TC.GREETING );
			return (Greeting)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating Greeting : "+e.getMessage(), 0 );
		}
	}
	
	public Greeting createGreeting(final Map attributeValues)
	{
		return createGreeting( getSession().getSessionContext(), attributeValues );
	}
	
	public TrackLatLong createTrackLatLong(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( ServicecoreConstants.TC.TRACKLATLONG );
			return (TrackLatLong)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating TrackLatLong : "+e.getMessage(), 0 );
		}
	}
	
	public TrackLatLong createTrackLatLong(final Map attributeValues)
	{
		return createTrackLatLong( getSession().getSessionContext(), attributeValues );
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.trackLatLongList</code> attribute.
	 * @return the trackLatLongList
	 */
	public List<TrackLatLong> getTrackLatLongList(final SessionContext ctx, final Customer item)
	{
		List<TrackLatLong> coll = (List<TrackLatLong>)item.getProperty( ctx, ServicecoreConstants.Attributes.Customer.TRACKLATLONGLIST);
	 ...
	 * @return the trackLatLongList
	 */
	public List<TrackLatLong> getTrackLatLongList(final Customer item)
	{
		return getTrackLatLongList( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Customer.trackLatLongList</code> attribute. 
	 * @param value the trackLatLongList
	 */
	public void setTrackLatLongList(final SessionContext ctx, final Customer item, final List<TrackLatLong> value)
	{
		item.setProperty(ctx, ServicecoreConstants.Attributes.Customer.TRACKLATLONGLIST,value == null || !value.isEmpty() ? value : null );
	}
	 ...
	 * @param value the trackLatLongList
	 */
	public void setTrackLatLongList(final Customer item, final List<TrackLatLong> value)
	{
		setTrackLatLongList( getSession().getSessionContext(), item, value );
	}
